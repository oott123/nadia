...
namespace nadia
{
    // http://www.mikeobrien.net/blog/taking-ownership-and-setting-admin
    ...
    internal class Security
    {
        public static void GrantAdministratorsAccess(string name, SE_OBJECT_TYPE type)
        {
            ...
            SetEntriesInAcl(1, ref explicitAccesss[0], 0, ref acl);
        ...
        private static extern bool LookupPrivilegeValueA(
            [InAttribute] [MarshalAsAttribute(UnmanagedType.LPStr)] string lpSystemName,
            [InAttribute] [MarshalAsAttribute(UnmanagedType.LPStr)] string lpName,
            [OutAttribute] out LUID lpLuid
        );
